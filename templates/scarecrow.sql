...
VALUES (8274, 'scarecrowshady', 10, '2020-08-13 11:27:10') /* Creature */;
...
VALUES (8274,   1,       5) /* HeartbeatInterval */
     ...
     , (8274,   3, 0.4000000059604645) /* HealthRate */
     , (8274,   4,     0.5) /* StaminaRate */
     , (8274,   5,       2) /* ManaRate */
     , (8274,  12,       0) /* Shade */
     , (8274,  13, 0.699999988079071) /* ArmorModVsSlash */
     , (8274,  14, 0.3199999928474426) /* ArmorModVsPierce */
     , (8274,  15, 0.3199999928474426) /* ArmorModVsBludgeon */
     , (8274,  16, 0.3199999928474426) /* ArmorModVsCold */
     , (8274,  17, 0.699999988079071) /* ArmorModVsFire */
     , (8274,  18, 0.3199999928474426) /* ArmorModVsAcid */
     , (8274,  19, 0.699999988079071) /* ArmorModVsElectric */
     ...
     , (8274,  64, 0.8600000143051147) /* ResistSlash */
     , (8274,  65, 0.41999998688697815) /* ResistPierce */
     , (8274,  66, 0.41999998688697815) /* ResistBludgeon */
     , (8274,  67,       1) /* ResistFire */
     , (8274,  68, 0.41999998688697815) /* ResistCold */
     , (8274,  69, 0.41999998688697815) /* ResistAcid */
     , (8274,  70, 0.8600000143051147) /* ResistElectric */
...
VALUES (8274,  6, 0, 3, 0,  54, 0, 578.4519653320312) /* MeleeDefense        Specialized */
     , (8274,  7, 0, 3, 0,  94, 0, 578.4519653320312) /* MissileDefense      Specialized */
     , (8274, 13, 0, 3, 0,  70, 0, 578.4519653320312) /* UnarmedCombat       Specialized */
     , (8274, 14, 0, 3, 0, 100, 0, 578.4519653320312) /* ArcaneLore          Specialized */
     , (8274, 15, 0, 3, 0,  60, 0, 578.4519653320312) /* MagicDefense        Specialized */
     , (8274, 20, 0, 3, 0,  50, 0, 578.4519653320312) /* Deception           Specialized */
     , (8274, 24, 0, 3, 0,  90, 0, 578.4519653320312) /* Run                 Specialized */
     , (8274, 31, 0, 3, 0,  46, 0, 578.4519653320312) /* CreatureEnchantment Specialized */
     , (8274, 33, 0, 3, 0,  46, 0, 578.4519653320312) /* LifeMagic           Specialized */
     , (8274, 34, 0, 3, 0,  46, 0, 578.4519653320312) /* WarMagic            Specialized */;
...
VALUES (8274, 0.06, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, 2, 0, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     ...
     , (8274, 0.17999999, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, 0, 2, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     ...
     , (8274, 0.29999998, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, -2, 0, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     , (8274, 0.35999998, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, -1.4, -1.4, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     ...
     , (8274, 0.53999996, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, 2, 0, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     , (8274, 0.59999996, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, 1.4, 1.4, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     , (8274, 0.65999997, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, 0, 2, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
     , (8274, 0.71999997, 8232, 120, 1, 1, 2, 4, -1, 0, 0, 0, -1.4, 1.4, 0, 1, 0, 0, 0) /* Generate Pumpkin (8232) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Specific */
